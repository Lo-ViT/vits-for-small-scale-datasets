...
"""
Since we had differences in runtimes, this copies the ViTs transformer from the vit_ss_ds repo (this repo) and embeds the ATS blocks as suggested in the original paper.
"""
